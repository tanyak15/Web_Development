...
// opposite of spread operatoer
// spread operator unpacks the array elements while rest is to pack elements into an array

//SPREAD , because anon right of =
const array = [, 2, ...[3, 4]];

//REST ,because on left sied of =
...
//here we are unpacking the array
...
const x = [23, 5, 7];
add(...x); // here we are packing the array i.e spread operator
